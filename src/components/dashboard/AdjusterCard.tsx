    ...
    >
      ...
      >
        ...
        <div className="p-3 rounded-xl bg-success/10 border border-success/20">
          ...
          <p className="text-sm text-success mt-1">+{formatCurrency(summary.positiveDifference)}</p>
        </div>
        ...
        <div className="p-3 rounded-xl bg-destructive/10 border border-destructive/20">
          ...
          <p className="text-sm text-destructive mt-1">{formatCurrency(summary.negativeDifference)}</p>
        </div>
      </div>
